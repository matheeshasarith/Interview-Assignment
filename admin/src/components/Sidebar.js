...
import { deactivateBusiness } from '.././redux/actions/users/userActions'
...
const SidebarDissableBusiness = ({ open, toggleSidebar, email }) => {
  // ** States
  ...
  const onSubmit = values => {
    if (isObjEmpty(errors)) {
      ...
      dispatch(
        deactivateBusiness({
          email,
          message: values['deactivate-message']
        })
      )
    }
  }
      ...
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <FormGroup>
          ...
          <Input
            ...
            innerRef={register({ required: true })}
            className={classnames({ 'is-invalid': errors['deactivate-message'] })}
          />
        </FormGroup>
...
export default SidebarDissableBusiness
