export const EVENT_Registered_LIST_REQUEST = 'EVENT_Registered_LIST_REQUEST'
export const EVENT_Registered_LIST_SUCCESS = 'EVENT_Registered_LIST_SUCCESS'
export const EVENT_Registered_LIST_FAIL = 'EVENT_Registered_LIST_FAIL'
...
export const EVENT_LIST_ALL_REQUEST = 'EVENT_LIST_ALL_REQUEST'
export const EVENT_LIST_ALL_SUCCESS = 'EVENT_LIST_ALL_SUCCESS'
export const EVENT_LIST_ALL_FAIL = 'EVENT_LIST_ALL_FAIL'
