...
const TokenValidation = () => {
  ...
  const { loading, success, error, events, page, pages } = userTokenVerification
  ...
  if (loading) {
    ...
    return (
      <div className='misc-wrapper'>
        ...
        <div className='misc-inner p-2 p-sm-3'>
          <div className='w-100 text-center'>
            <h2 className='mb-1'>Successfully Authenticated. 🚀</h2>
            <p className='mb-3'>We have authenticated your account successfully.  Please login to continue!</p>
